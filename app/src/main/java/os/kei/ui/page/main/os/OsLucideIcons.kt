...
@Composable
internal fun appLucideArchiveIcon(): ImageVector = osLucideVector(LucideR.drawable.lucide_ic_archive)
...
@Composable
internal fun appLucideChevronRightIcon(): ImageVector =
    osLucideVector(LucideR.drawable.lucide_ic_chevron_right)
