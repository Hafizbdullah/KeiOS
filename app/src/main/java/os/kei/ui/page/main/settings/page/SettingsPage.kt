...
fun SettingsPage(
    ...
    val settingsSearchCardInput =
        SettingsSearchCardRenderInput(
            ...
            nonHomeBackgroundDepthEnabled = nonHomeBackgroundDepthEnabled,
            onNonHomeBackgroundDepthEnabledChanged = onNonHomeBackgroundDepthEnabledChanged,
            nonHomeBackgroundSaturation = nonHomeBackgroundSaturation,
            onNonHomeBackgroundSaturationChanged = onNonHomeBackgroundSaturationChanged,
    ...
    AppPageScaffold(
        ...
        Box(
            Modifier
                .fillMaxSize()
                .pageRootTestTag(KeiOsTestTags.SettingsPageRoot),
        ) {
