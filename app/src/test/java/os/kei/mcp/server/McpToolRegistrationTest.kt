...
class McpToolRegistrationTest {
    ...
    fun catalogSchemasAndAnnotationsReachSdkTools() {
        ...
        assertTrue(SUBAGENT_RESOURCE_URI in server.resources.keys)
        ...
        assertTrue(sourceModeSchema.contains("fdroid_repository"))
        ...
        assertTrue(filterModeSchema.contains("fdroid_repository"))
