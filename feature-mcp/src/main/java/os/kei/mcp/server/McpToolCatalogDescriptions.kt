...
internal object McpToolCatalogDescriptions {
    val english = mapOf(
        ...
        "keios.privilege.status" to "Read the active privileged backend and its status.",
    ...
    private val chinese = mapOf(
        ...
        "keios.privilege.status" to "读取当前特权后端及其状态。",
    ...
    private val japanese = mapOf(
        ...
        "keios.privilege.status" to "現在の特権バックエンドとその状態を読み取ります。",
