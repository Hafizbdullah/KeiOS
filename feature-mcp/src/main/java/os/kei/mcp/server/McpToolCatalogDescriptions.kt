...
internal object McpToolCatalogDescriptions {
    val english = mapOf(
        ...
        "keios.github.tracks.export" to "Export tracked GitHub repository, Git repository, subscription, or F-Droid entries as keios.github.tracked/v3 JSON. Args: repoFilter, sourceMode, filterMode, sortMode, sortDirection.",
    ...
    private val chinese = mapOf(
        ...
        "keios.github.tracks.export" to "将已追踪 GitHub 仓库、Git 仓库、订阅项目或 F-Droid 来源导出为 keios.github.tracked/v3 JSON。参数：repoFilter、sourceMode、filterMode、sortMode、sortDirection。",
    ...
    private val japanese = mapOf(
        ...
        "keios.github.tracks.export" to "追跡中の GitHub リポジトリ、Git リポジトリ、購読プロジェクト、F-Droid ソースを keios.github.tracked/v3 JSON としてエクスポートします。引数: repoFilter、sourceMode、filterMode、sortMode、sortDirection。",
