...
- [x] Build baseline is `minSdk=35`, `compileSdk=37`, `targetSdk=37`, Java 21, Gradle Wrapper
  `9.5.1`, Kotlin `2.4.0`, Compose `1.11.3`, and Android Gradle Plugin `9.2.1`.
